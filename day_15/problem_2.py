import numpy as np
## every ## marks where code was altered to perform the scan for x
# instead of y. this was poorly implemented but got me the answer... ugh
...
for y in range(0, 4000001):
    ...
    for line in lines:
        ...
        d2y = np.abs(sensor_x - y) ##

        if d2y < mhd: # we have some locations to eliminate
            left_x = sensor_y - (mhd-d2y)  ##
            right_x = sensor_y + (mhd-d2y) ##
